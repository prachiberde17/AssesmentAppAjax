						...
						<div class="col-md-6 text-center">
								...
								<div class="col-md-12">
										<div class="creationcontent">
												...
												<p>McClintock's eye for detail certainly helped narrow the whereabouts of lorem
														ipsum's origin, however, the “how and when” still remain something of a mystery, with
														competing theories and timelines.</p>
										</div>
								</div>
						</div>
						<div class="col-md-6">
