					...
					<div class="rightside">
						<div class="rightdiv settest step1"
							...
							<div class="invitecandidates">
								...
								<div class="right">
									<h4>
										Test:
										<%=test.getTestName()%>. Click on Section below to see a
										preview
									</h4>
									<p>
										Category:
						...
						<div class="nextbuttons">
							...
							<a class="cancelbtn" href="testlist">Cancel...</a> <a
								class="backbtn backstep3" href="showUsers">Back</a> <a
								class="nextbtn" href="shareTestWithUsers">Send Invitation</a>
						</div>
