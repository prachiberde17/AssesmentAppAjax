...
.rightdivU .rightdivU .addqueform input[type="text"], .rightdivU .rightdivU .addqueform input[type="email"]
	{
	border: 2px solid #8f9396;
	padding: 5px;
	width: 50%;
												...
												<div class="leftdivU">
														...
														<div class="topmenu text-right">
																...
																<a href="javascript:notify('Information', 'Feature Coming Soon');"><i
																		class="fa fa-arrow-left"></i></a> 4/40 <a
																		href="javascript:notify('Information', 'Feature Coming Soon');"><i
