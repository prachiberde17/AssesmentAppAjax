...
public class UserTestSessionServiceImpl implements UserTestSessionService {
	...
	public List<String> getUserName(String testName, String companyId) {
		return userTestSessionRep.getUserName(testName,companyId);
	}

	@Override
	public List<String> getCompanyId() {
		return userTestSessionRep.getCompanyId();
	}

	@Override
	public List<String> getTestName(String companyId) {
		return userTestSessionRep.getTestName(companyId);
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public List<String> getTestName_new() {
		// TODO Auto-generated method stub
		return userTestSessionRep.getTestName_new() ;
	}

	@Override
	public List<String> getUserName_new() {
		// TODO Auto-generated method stub
		return userTestSessionRep.getUserName_new();
	}
