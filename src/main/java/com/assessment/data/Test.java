...
public class Test extends Base {
	...
	public String toString() {
		return "Test [testName=" + testName + ", qualifier1=" + qualifier1 + ", qualifier2=" + qualifier2
				...
				+ showFinalScoreToParticipants + ", questionOrder=" + questionOrder + ", skills=" + skills + ", skls="
				+ skls + ", passPercent=" + passPercent + ", sentToStudent=" + sentToStudent + ", sendRecommReport="
				+ sendRecommReport + ", category=" + category + ", uDate=" + uDate + ", cDate=" + cDate
				+ ", sendToAdminEmail=" + sendToAdminEmail + ", users=" + users + ", sectionDtos=" + sectionDtos
				+ ", randomQuestions=" + randomQuestions + ", publicUrl=" + publicUrl + ", domainEmailSupported="
				+ domainEmailSupported + ", testType=" + testType + ", defaultSendTo=" + defaultSendTo
				+ ", optionalSendTo=" + optionalSendTo + "]";
	}
