...
public class AssessmentTestData {
	...
	public String toString() {
		return "AssessmentTestData [percentageMarksRecieved=" + percentageMarksRecieved + ", testName=" + testName
				+ ", user=" + user + ", noOfAttempts=" + noOfAttempts + ", pass=" + pass + ", sectionResults="
				+ sectionResults + ", companyId=" + companyId + ", resultInString=" + resultInString
				+ ", testInviteSent=" + testInviteSent + ", sharedDirect=" + sharedDirect
				+ ", noOfQuestionsNotAnswered=" + noOfQuestionsNotAnswered + ", testStartDate=" + testStartDate
