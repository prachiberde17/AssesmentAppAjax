...
public class Templates2 {
	...
	static {
		...
		bold22CenteredStyle = stl.style(boldCenteredStyle)
                             .setFontSize(24);
		columnStyle         = stl.style(rootStyle).setVerticalTextAlignment(VerticalTextAlignment.MIDDLE).setLeftPadding(2).setRightPadding(2).setFontName("gnu-free").setBorder(stl.pen1Point()).setFontSize(10).setBackgroundColor(new Color(162, 192, 242));
		...
		columnTitleStyle    = stl.style(columnStyle).setFontSize(12).setBold(true)
		                         .setBorder(stl.pen1Point())
		                         .setHorizontalTextAlignment(HorizontalTextAlignment.CENTER)
		                         .setBackgroundColor(new Color(18,102,237))
